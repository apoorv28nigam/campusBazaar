  ...
  const handleVerifyOTP = async (otp) => {
    ...
    try {
      ...
      if (res.data.session) {
        ...
        toast.success(`Welcome to CampusCart, ${form.name.split(' ')[0]}!`);
        navigate('/buy');
      } else {
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 24px 40px' }}>
      <div style={{ width: '100%', maxWidth: 480 }}>
        ...
        >
          ...
          <h1 style={{ fontSize: 28, fontWeight: 800, color: 'var(--text)', fontFamily: 'Outfit, sans-serif' }}>Join CampusCart</h1>
